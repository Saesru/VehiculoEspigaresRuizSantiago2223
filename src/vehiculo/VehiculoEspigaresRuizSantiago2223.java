 ...
 */
public class VehiculoEspigaresRuizSantiago2223 {
    ...
    public VehiculoEspigaresRuizSantiago2223 ()
    {
    }
    // Constructor con parámetro para iniciar todas las propiedades de la clase
    
    
    public VehiculoEspigaresRuizSantiago2223 (String nom, double precio, int stock)
    {
        this.nombre =nom;
        this.precio=precio;
        this.stock=stock;
